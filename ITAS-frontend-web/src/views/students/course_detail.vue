            ...
            <div class="main-content">
                <div class="content">
                    ...
                    <div class="action-buttons">
                        ...
                        <button class="btn btn-secondary coming-soon" onclick="showComingSoon('课程视频')">🎥 课程视频</button>
                        <button class="btn btn-info coming-soon" onclick="showComingSoon('在线讨论')">💬 在线讨论</button>
                    </div>
                </div>
            </div>
            ...
            <div class="sidebar">
                <div class="content">
                    ...
                    <div class="section">
                        ...
                        <p>本课程旨在帮助学生掌握相关知识和技能，通过理论学习和实践操作相结合的方式，培养学生的综合能力。</p>
                        <button class="btn coming-soon" style="margin-top: 1rem; width: 100%;"
                            onclick="showComingSoon('详细介绍')">查看详细介绍</button>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <button class="btn coming-soon" style="width: 100%;"
                            onclick="showComingSoon('更多公告')">查看更多公告</button>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <ul class="resource-list">
                            ...
                            <li><a href="#" class="coming-soon" onclick="showComingSoon('电子教材'); return false;">电子教材</a>
                            </li>
                            <li><a href="#" class="coming-soon" onclick="showComingSoon('练习题库'); return false;">练习题库</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="action-buttons" style="flex-direction: column; gap: 0.5rem;">
                            <button class="btn coming-soon" onclick="showComingSoon('学习笔记')">📒 学习笔记</button>
                            <button class="btn coming-soon" onclick="showComingSoon('错题本')">❌ 错题本</button>
                            <button class="btn coming-soon" onclick="showComingSoon('学习计划')">📅 学习计划</button>
                        </div>
                    </div>
                </div>
            </div>
