        ...
        <div class="container py-4 bg-light rounded">
            ...
            <div class="card shadow-sm border-0 rounded-lg">
                <div class="card-header bg-primary text-white py-3">
                    ...
                    <a href="/course/assignment_detail/{{ assignment.id }}?flag=1" class="btn btn-danger shadow-sm">
                        <i class="fas fa-trash me-1"></i> 删除作业
                    </a>

                </div>
                <div class="card-body p-4">
                    <form method="POST" action="/course/assignment_detail/{{ assignment.id }}" class="needs-validation"
                        novalidate>
                        ...
                        <div class="form-group mb-4">
                            <label for="description" class="form-label fw-bold">作业描述</label>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            <a href="/course/assignments/{{ course.id }}"
...
export default {
    ...
    mounted() {
        ...
        link1.href = 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css';
        link2.rel = 'stylesheet';
        link2.href = 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css';
