  ...
  <div class="teacher-profile">
    ...
    <div class="container">
      ...
      <div class="create-course">
        <button @click="go_to_create_course(this.userInfo.user_id)">
          创建新课程
        </button>
      </div>
      ...
      <div class="semester-section" v-for="semesterCourses in this.couresList">
        ...
        <div class="course-grid">
          <div class="course-card" v-for="course in semesterCourses.courses">
            ...
            <button @click="go_to_course_manager(course.id)">
              进入课程管理
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    //转跳创建课程
    go_to_create_course(teacherId) {
      this.$router.push(`/create_course/${teacherId}`);
    },
  },
};
</script>
